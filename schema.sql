-- ============================================================
-- CONSOLIDATED SCHEMA
-- Generated from 53 migration files
...
-- ── 20260624210445_c7fc7a7a-a98b-43fb-8dbe-758c74372a74.sql ─────────────────────────────────────────
...
-- ── 20260624211457_07f93b64-f5ec-4041-abf6-bd040eeae93d.sql ─────────────────────────────────────────
...
-- ── 20260624214548_003ba537-4ef7-434f-a5e3-e080faed3694.sql ─────────────────────────────────────────
...
-- 4. Remove get_email_notification_config RPC â€” check is moved into send-email edge function
...
-- ── 20260624214950_30723167-9186-416e-91e6-3a2df4789a0d.sql ─────────────────────────────────────────
...
-- ── 20260624220824_6c38358b-c316-46c4-9a07-275461d8edcb.sql ─────────────────────────────────────────
...
-- ── 20260624222036_17b58750-44d4-4d80-b2c7-85bf5cdcedaf.sql ─────────────────────────────────────────
...
-- ── 20260624222125_955bab86-39f7-47ce-b59f-8653512e6157.sql ─────────────────────────────────────────
GRANT EXECUTE ON FUNCTION public.redeem_signup_code(text) TO anon;

-- ── 20260624223140_b53e2bd3-c536-4304-b479-94d1e039843b.sql ─────────────────────────────────────────
REVOKE EXECUTE ON FUNCTION public.redeem_signup_code(text) FROM PUBLIC, anon, authenticated;

-- ── 20260624223901_87e0d8b7-2068-42fa-b166-2be1c0a21398.sql ─────────────────────────────────────────
...
-- ── 20260624225739_625ee44b-dd3b-41a4-a616-29238c157f3b.sql ─────────────────────────────────────────
...
-- ── 20260624231016_dc6ffaff-7595-49fc-a7a4-061ed5a02fbd.sql ─────────────────────────────────────────
...
-- ── 20260625000000_feature_flag_foundation.sql ─────────────────────────────────────────
