...
export default function AdminDashboard() {
  ...
  const { stats, recentJobs, revenueSeries, todayAppts, staffLoad, isLoading, refresh } =
    useDashboardStats(appointmentsEnabled);
      ...
      <div className="min-w-0 max-w-full space-y-5 sm:space-y-6 lg:space-y-8">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div className="min-w-0">
            ...
            <h1 className="mt-1 flex items-center gap-3 text-display text-[2rem] leading-[1.05] tracking-tight sm:text-5xl lg:text-[3.25rem]">
              ...
              <span>Hello, <span className="text-primary">{firstName}</span></span>
            </h1>
