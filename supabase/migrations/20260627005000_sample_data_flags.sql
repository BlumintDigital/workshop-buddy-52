-- Add generate_sample_data and setup_demo_users feature flags (off by default).
-- These gate the Data tab buttons in AdminSettings so they must be explicitly enabled.
...
VALUES ('generate_sample_data', false), ('setup_demo_users', false)
ON CONFLICT (key) DO NOTHING;

-- New flags COALESCE to false; existing flags keep their true default.
